(function () {
  const KTWS = {
    website: "https://ktworldsolutions.com",
    quote: "contact.html",
    phone: "tel:+12523265269",
    email: "mailto:ktworldsolutionsllc@outlook.com",
    connect: "connect.html",
    trucking: "trucking.html",
    courier: "medical-courier.html",
    parking: "truck-parking.html",
    assisted: "assisted-living.html",
  ...
  function createHub() {
    ...
    panel.innerHTML = `
      <div class="ktws-hub-head">
        <div><strong>KTWS Hub</strong><span>Quick links, quote requests, services, and socials.</span></div>
      ...
      <div class="ktws-hub-grid">
        ...
        <a href="${KTWS.trucking}">🚛 Trucking<small>Regional freight</small></a>
        <a href="${KTWS.courier}">🧬 Medical Courier<small>Healthcare logistics</small></a>
        <a href="${KTWS.parking}">🅿️ Truck Parking<small>Development</small></a>
        <a href="${KTWS.assisted}">🏡 Assisted Living<small>Care operations</small></a>
