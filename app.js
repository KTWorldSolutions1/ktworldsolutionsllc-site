(function () {
  ...
  function injectFixStyles() {
    if (document.getElementById("ktws-fix-styles")) return;
    const style = document.createElement("style");
    style.id = "ktws-fix-styles";
    style.textContent = `
      /* Restore/preserve the homepage Now Hiring section */
      .ktws-hiring-restore {
        background:
      ...
      /* Travis leadership card photo crop fix */
      #travis-leadership img,
      .team-card img[src*="travis"],
      .team-card img[alt*="Travis"],
      .team-card img[alt*="Lewter"] {
